      ...
      <section class="relative flex flex-col p-5 items-center justify-between h-auto min-h-[865px] bg-[url('/src/assets/images/hero-bg-artikel.png')] bg-cover bg-center rounded-3xl">
        ...
        <div>
          ...
          <p class="text-base sm:text-xl text-gray-300 text-center max-w-xl md:max-w-4xl mx-auto mb-6 md:mb-5">
            "Temukan artikel inspiratif seputar seni, tradisi, dan kearifan
            lokal Nusantara yang tidak hanya menceritakan masa lalu, tetapi juga
            menghadirkan makna yang relevan dengan kehidupan modern. Dari musik
            tradisional hingga kuliner khas, setiap cerita membawa nilai yang
            bisa kita pelajari, lestarikan, dan teruskan untuk generasi
            mendatang.
          </p>
          <NavKategori />
        </div>
