export default function CardPrimary({ imgSrc, title, description }) {
  return (
    <div class="h-full">
      <div class="bg-[#1B323B] flex flex-col rounded-2xl p-7 hover:shadow gap-5 text-white group hover:bg-white transition duration-500 h-full">
        ...
        <div>
          ...
          <p class="text-gray-400 text-[18px]">{description}</p>
        </div>
      </div>
    </div>
  );
